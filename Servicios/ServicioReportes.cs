...
namespace ManejoPresupuesto.Servicios
{
    ...
    public class ServicioReportes: IServicioReportes
    {
        ...
        public ServicioReportes(IRepositorioTansacciones repositorioTansacciones, 
            ...
            int mes, int año, dynamic ViewBag)
        {
            ...
            var modelo = await repositorioTansacciones.ObtenerPorSemana(parametro);
            return modelo;
        }
            ...
            ObtenerReporteTransaccionesDetalladas(int usuarioId, int mes, int año, dynamic ViewBag)
        {
            ...
            var transacciones = await repositorioTansacciones.ObtenerPorUsuarioId(parametro);
            ...
            int mes, int año, dynamic ViewBag)
        {
            ...
            var transacciones = await repositorioTansacciones.
