...
namespace ManejoPresupuesto.Controllers
{
    public class TransaccionesController: Controller
    {
        ...
        private readonly IRepositorioTansacciones repositorioTansacciones;
        ...
        public TransaccionesController(IServicioUsuarios servicioUsuarios, 
            ...
            IRepositorioTansacciones repositorioTansacciones,
            IMapper mapper, IServicioReportes servicioReportes)
        {
            this.servicioUsuarios = servicioUsuarios;
            this.repositorioCuentas = repositorioCuentas;
            this.repositorioCategorias = repositorioCategorias;
            this.repositorioTansacciones = repositorioTansacciones;
            this.mapper = mapper;
        ...
        public async Task<IActionResult> Mensual(int año)
        {
            ...
            var transaccionesPorMes = await repositorioTansacciones.ObtenerPorMes(usuarioId, año);
        ...
        public async Task<FileResult> ExportarExcelPorMes(int mes, int año)
        {
            ...
            var transacciones = await repositorioTansacciones.ObtenerPorUsuarioId
        ...
        public async Task<IActionResult> ObtenerTransaccionesCalendario(DateTime start, DateTime end)
        {
            var usuarioId = servicioUsuarios.ObtenerUsuarioId();
        ...
        public async Task<IActionResult> Crear(TransaccionCreacionViewModel modelo)
        {
            ...
            await repositorioTansacciones.Crear(modelo);
        ...
        {
            var usuarioId = servicioUsuarios.ObtenerUsuarioId();
            var transaccion = await repositorioTansacciones.ObtenerPorId(id, usuarioId);
        ...
        public async Task<IActionResult> Editar(TransaccionActualizacionViewModel modelo)
        {
            ...
            await repositorioTansacciones.Actualizar(transaccion, 
        ...
        public async Task<IActionResult> Borrar(int id, string urlRetorno = null)
        {
            ...
            await repositorioTansacciones.Borrar(id);
